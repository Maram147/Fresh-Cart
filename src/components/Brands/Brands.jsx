  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {brands.map((item) => (
          <Link to={`/brandsdetails/${item._id}`} className="no-underline" key={item._id}>
            <div className="product brand bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <img
                src={item.image}
